export default function PrizeItemSVG() {
  return (
    <svg
      className="prizeItemSVG"
      width="376"
      height="40"
      viewBox="0 0 376 40"
      fill="none"
    ...
    >
      <path className="leftStroke" d="M69 20H0" stroke="#D0D0D8" />
      <path className="rightStroke" d="M376 20H307" stroke="#D0D0D8" />
      <path
        className="outline"
